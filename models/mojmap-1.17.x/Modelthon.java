...
public class Modelthon<T extends Entity> extends EntityModel<T> {
	...
	public static final ModelLayerLocation LAYER_LOCATION = new ModelLayerLocation(
			new ResourceLocation("modid", "thon"), "main");
	...
	public static LayerDefinition createBodyLayer() {
		...
		PartDefinition body_front = partdefinition.addOrReplaceChild("body_front", CubeListBuilder.create()
				.texOffs(0, 14).addBox(-1.5F, -8.5F, 0.0F, 3.0F, 6.0F, 8.0F, new CubeDeformation(0.0F)),
				PartPose.offset(0.0F, 24.0F, -4.0F));

		PartDefinition body_back = partdefinition.addOrReplaceChild("body_back", CubeListBuilder.create().texOffs(0, 0)
				.addBox(-1.5F, -8.5F, 0.0F, 3.0F, 6.0F, 8.0F, new CubeDeformation(0.0F)),
				PartPose.offset(0.0F, 24.0F, 4.0F));

		PartDefinition dorsal_front = partdefinition.addOrReplaceChild("dorsal_front",
				CubeListBuilder.create().texOffs(0, 4)
						.addBox(0.0F, -5.5F, 0.0F, 0.0F, 2.0F, 2.0F, new CubeDeformation(0.0F)).texOffs(0, 2)
						.addBox(0.0F, 2.5F, 0.0F, 0.0F, 2.0F, 2.0F, new CubeDeformation(0.0F)),
				PartPose.offset(0.0F, 19.0F, 2.0F));

		PartDefinition dorsal_back = partdefinition.addOrReplaceChild("dorsal_back",
				CubeListBuilder.create().texOffs(4, 5)
						.addBox(0.0F, -4.5F, -4.0F, 0.0F, 1.0F, 2.0F, new CubeDeformation(0.0F)).texOffs(4, 2)
						.addBox(0.0F, 2.5F, -4.0F, 0.0F, 1.0F, 2.0F, new CubeDeformation(0.0F)),
				PartPose.offset(0.0F, 19.0F, 4.0F));

		PartDefinition dorsal_back_r1 = dorsal_back.addOrReplaceChild("dorsal_back_r1",
				CubeListBuilder.create().texOffs(4, 3).addBox(0.0F, -5.5F, 5.0F, 0.0F, 1.0F, 2.0F,
						new CubeDeformation(0.0F)),
				PartPose.offsetAndRotation(0.0F, 5.0F, -4.0F, -0.3927F, 0.0F, 0.0F));

		PartDefinition dorsal_back_r2 = dorsal_back
				.addOrReplaceChild("dorsal_back_r2",
						CubeListBuilder.create().texOffs(4, 4).addBox(0.0F, -7.5F, 8.0F, 0.0F, 1.0F, 2.0F,
								new CubeDeformation(0.0F)),
						PartPose.offsetAndRotation(0.0F, 5.0F, -4.0F, 0.2182F, 0.0F, 0.0F));

		PartDefinition tailfin = partdefinition.addOrReplaceChild("tailfin", CubeListBuilder.create().texOffs(0, 14)
				.addBox(-1.0F, -7.5F, 0.0F, 2.0F, 4.0F, 1.0F, new CubeDeformation(0.0F)),
				PartPose.offset(0.0F, 24.0F, 12.0F));

		PartDefinition tailfin_r1 = tailfin.addOrReplaceChild("tailfin_r1",
				CubeListBuilder.create().texOffs(14, 9).addBox(0.0F, -13.5F, 4.0F, 0.0F, 1.0F, 5.0F,
						new CubeDeformation(0.0F)),
		...
		PartDefinition tailfin_r2 = tailfin.addOrReplaceChild("tailfin_r2",
				CubeListBuilder.create().texOffs(14, 10).addBox(0.0F, 5.5F, 12.0F, 0.0F, 1.0F, 5.0F,
						new CubeDeformation(0.0F)),
				PartPose.offsetAndRotation(0.0F, 0.0F, -12.0F, 0.8727F, 0.0F, 0.0F));

		PartDefinition head = partdefinition.addOrReplaceChild("head", CubeListBuilder.create().texOffs(14, 0).addBox(
				-1.0F, -5.5F, -3.0F, 2.0F, 5.0F, 3.0F, new CubeDeformation(0.0F)), PartPose.offset(0.0F, 21.0F, -4.0F));
		...
		PartDefinition leftFin_r1 = leftFin.addOrReplaceChild("leftFin_r1",
				CubeListBuilder.create().texOffs(0, 2).addBox(1.51F, -6.87F, -2.0F, 3.0F, 0.0F, 2.0F,
						new CubeDeformation(0.0F)),
		...
		PartDefinition rightFin_r1 = rightFin
				.addOrReplaceChild("rightFin_r1",
						CubeListBuilder.create().texOffs(0, 0).addBox(-4.51F, -6.87F, -2.0F, 3.0F, 0.0F, 2.0F,
								new CubeDeformation(0.0F)),
