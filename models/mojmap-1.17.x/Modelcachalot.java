...
public class Modelcachalot<T extends Entity> extends EntityModel<T> {
	...
	public static final ModelLayerLocation LAYER_LOCATION = new ModelLayerLocation(
			new ResourceLocation("modid", "cachalot"), "main");
	private final ModelPart corp;
	private final ModelPart aileron_droit;
	private final ModelPart queue;
	private final ModelPart aileron_gauche;
	...
	public static LayerDefinition createBodyLayer() {
		...
		PartDefinition corp = partdefinition.addOrReplaceChild("corp",
				CubeListBuilder.create().texOffs(0, 56)
						.addBox(2.25F, -16.0F, -12.0F, 45.0F, 32.0F, 24.0F, new CubeDeformation(0.0F)).texOffs(0, 0)
						.addBox(-51.75F, -16.0F, -12.0F, 54.0F, 32.0F, 24.0F, new CubeDeformation(0.0F)),
		...
		PartDefinition aileron_droit = partdefinition.addOrReplaceChild("aileron_droit",
				CubeListBuilder.create().texOffs(0, 10)
						.addBox(6.1825F, -0.5F, -8.6666F, 1.0F, 1.0F, 9.0F, new CubeDeformation(0.0F)).texOffs(156, 14)
		...
		PartDefinition cube_r1 = aileron_droit.addOrReplaceChild("cube_r1",
				CubeListBuilder.create().texOffs(0, 61)
						.addBox(-4.0F, -0.5F, -13.0F, 8.0F, 1.0F, 4.0F, new CubeDeformation(0.0F)).texOffs(88, 123)
						.addBox(-5.0F, -0.5F, -9.0F, 10.0F, 1.0F, 3.0F, new CubeDeformation(0.0F)).texOffs(138, 96)
						.addBox(-6.0F, -0.5F, -6.0F, 12.0F, 1.0F, 13.0F, new CubeDeformation(0.0F)),
				PartPose.offsetAndRotation(-0.8175F, 0.0F, -14.6666F, 0.0F, 0.3054F, 0.0F));

		PartDefinition queue = partdefinition.addOrReplaceChild("queue", CubeListBuilder.create().texOffs(112, 112)
				.addBox(-29.25F, -13.75F, -9.5833F, 29.0F, 28.0F, 20.0F, new CubeDeformation(0.0F)),
				PartPose.offset(-54.75F, 7.75F, -0.4167F));

		PartDefinition cube_r2 = queue.addOrReplaceChild("cube_r2",
				CubeListBuilder.create().texOffs(145, 160)
						.addBox(-11.0F, -26.7F, -2.5F, 13.0F, 6.0F, 5.0F, new CubeDeformation(0.0F)).texOffs(0, 161)
		...
		PartDefinition aileron_gauche = partdefinition.addOrReplaceChild("aileron_gauche",
				CubeListBuilder.create().texOffs(0, 0)
						.addBox(6.1825F, -0.5F, 5.3334F, 1.0F, 1.0F, 9.0F, new CubeDeformation(0.0F)).texOffs(88, 112)
		...
		PartDefinition cube_r3 = aileron_gauche.addOrReplaceChild("cube_r3",
				CubeListBuilder.create().texOffs(0, 56)
						.addBox(-4.0F, -0.5F, -13.0F, 8.0F, 1.0F, 4.0F, new CubeDeformation(0.0F)).texOffs(114, 63)
						.addBox(-5.0F, -0.5F, -9.0F, 10.0F, 1.0F, 3.0F, new CubeDeformation(0.0F)).texOffs(132, 0)
						.addBox(-6.0F, -0.5F, -6.0F, 12.0F, 1.0F, 13.0F, new CubeDeformation(0.0F)),
				PartPose.offsetAndRotation(-0.8175F, 0.0F, -0.6666F, 0.0F, 0.3054F, 0.0F));

		PartDefinition tete = partdefinition.addOrReplaceChild("tete", CubeListBuilder.create().texOffs(0, 112)
				.addBox(0.0F, -20.999F, -12.0F, 32.0F, 25.0F, 24.0F, new CubeDeformation(0.0F)),
				PartPose.offset(44.0F, 12.999F, 0.0F));

		PartDefinition cube_r4 = tete.addOrReplaceChild("cube_r4",
				CubeListBuilder.create().texOffs(132, 32).addBox(-16.0F, -3.0F, -12.0F, 32.0F, 7.0F, 24.0F,
						new CubeDeformation(0.0F)),
				PartPose.offsetAndRotation(16.0F, 8.001F, 0.0F, 0.0F, 0.0F, 0.0873F));

		PartDefinition dents = tete.addOrReplaceChild("dents",
				CubeListBuilder.create().texOffs(3, 175)
		...
		PartDefinition cube_r5 = dents.addOrReplaceChild("cube_r5",
				CubeListBuilder.create().texOffs(3, 175)
						.addBox(-0.5F, -2.0F, -22.5F, 1.0F, 2.0F, 1.0F, new CubeDeformation(0.0F)).texOffs(3, 175)
						...
						.addBox(-0.5F, -2.0F, -2.5F, 1.0F, 2.0F, 1.0F, new CubeDeformation(0.0F)).texOffs(3, 175)
