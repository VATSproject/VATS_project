...
public class Modelcrevette<T extends Entity> extends EntityModel<T> {
	...
	public static final ModelLayerLocation LAYER_LOCATION = new ModelLayerLocation(
			new ResourceLocation("modid", "crevette"), "main");
	private final ModelPart crevette_corps;
	private final ModelPart crevette_queue;
	...
	public static LayerDefinition createBodyLayer() {
		...
		PartDefinition crevette_corps = partdefinition.addOrReplaceChild("crevette_corps",
				CubeListBuilder.create().texOffs(0, 0)
						.addBox(-2.0F, -7.0F, -4.0F, 3.0F, 3.0F, 5.0F, new CubeDeformation(0.0F)).texOffs(9, 3)
		...
		PartDefinition crevette_queue = partdefinition.addOrReplaceChild("crevette_queue",
				CubeListBuilder.create().texOffs(16, 1)
						.addBox(-1.5F, -1.625F, -0.125F, 3.0F, 3.0F, 2.0F, new CubeDeformation(0.0F)).texOffs(0, 16)
