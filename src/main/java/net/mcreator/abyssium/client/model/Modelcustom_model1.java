...
public class Modelcustom_model1<T extends Entity> extends EntityModel<T> {
	...
	public static final ModelLayerLocation LAYER_LOCATION = new ModelLayerLocation(new ResourceLocation("abyssium2", "modelcustom_model_1"), "main");
	public final ModelPart plastron;
	...
	public static LayerDefinition createBodyLayer() {
		...
		PartDefinition plastron = partdefinition.addOrReplaceChild("plastron",
				CubeListBuilder.create().texOffs(0, 0).addBox(-2.0F, 3.0F, 2.0F, 4.0F, 9.0F, 4.0F, new CubeDeformation(0.0F)).texOffs(12, 14)
		...
		PartDefinition bb_main = partdefinition
				.addOrReplaceChild(
						"bb_main", CubeListBuilder.create().texOffs(0, 0).addBox(-1.0F, -1.0F, 0.0F, 1.0F, 1.0F, 1.0F, new CubeDeformation(0.0F))
