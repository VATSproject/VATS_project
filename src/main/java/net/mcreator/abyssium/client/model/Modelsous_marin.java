...
public class Modelsous_marin<T extends Entity> extends EntityModel<T> {
	...
	public static final ModelLayerLocation LAYER_LOCATION = new ModelLayerLocation(new ResourceLocation("abyssium2", "modelsous_marin"), "main");
	public final ModelPart sous_marin;
	...
	public static LayerDefinition createBodyLayer() {
		...
		PartDefinition sous_marin = partdefinition.addOrReplaceChild("sous_marin",
				CubeListBuilder.create().texOffs(0, 34).addBox(-22.0F, -1.0F, 0.0F, 22.0F, 1.0F, 33.0F, new CubeDeformation(0.0F)).texOffs(0, 0)
		...
		PartDefinition cube_r1 = sous_marin.addOrReplaceChild("cube_r1",
				CubeListBuilder.create().texOffs(129, 22).addBox(-3.5F, -2.0F, -1.0F, 7.0F, 3.0F, 1.0F, new CubeDeformation(0.0F)),
				PartPose.offsetAndRotation(-10.5F, -12.0F, 8.0F, 0.8727F, 0.0F, 0.0F));
		PartDefinition cube_r2 = sous_marin.addOrReplaceChild("cube_r2",
				CubeListBuilder.create().texOffs(135, 2).addBox(-0.5F, -13.0F, -1.0F, 1.0F, 13.0F, 1.0F, new CubeDeformation(0.0F)),
		...
		PartDefinition helice = partdefinition.addOrReplaceChild("helice",
				CubeListBuilder.create().texOffs(24, 0).addBox(-0.5F, -0.5F, 0.0F, 1.0F, 1.0F, 3.0F, new CubeDeformation(0.0F)).texOffs(17, 57)
