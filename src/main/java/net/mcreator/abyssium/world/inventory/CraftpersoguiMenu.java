...
public class CraftpersoguiMenu extends AbstractContainerMenu implements Supplier<Map<Integer, Slot>> {
	...
	public CraftpersoguiMenu(int id, Inventory inv, FriendlyByteBuf extraData) {
		super(Abyssium2ModMenus.CRAFTPERSOGUI, id);
