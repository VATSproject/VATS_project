...
public class BananierFeature extends Feature<NoneFeatureConfiguration> {
	public static final BananierFeature FEATURE = (BananierFeature) new BananierFeature().setRegistryName("abyssium2:bananier");
	...
	public boolean place(FeaturePlaceContext<NoneFeatureConfiguration> context) {
		...
		if (!dimensionCriteria)
			return false;
		if (template == null)
			template = context.level().getLevel().getStructureManager().getOrCreate(new ResourceLocation("abyssium2", "bananier"));
		if (template == null)
			return false;
