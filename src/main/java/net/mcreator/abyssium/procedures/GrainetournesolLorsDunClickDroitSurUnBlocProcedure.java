...
public class GrainetournesolLorsDunClickDroitSurUnBlocProcedure {
	public static void execute(LevelAccessor world, double x, double y, double z, Entity entity) {
		if (entity == null)
			return;
		if ((world.getBlockState(new BlockPos((int) x, (int) y, (int) z))).getBlock() == Blocks.FARMLAND) {
			world.setBlock(new BlockPos((int) x, (int) (y + 1), (int) z), Abyssium2ModBlocks.TSTG_1.defaultBlockState(), 3);
			if ((new Object() {
				...
				if (entity instanceof Player _player) {
					ItemStack _stktoremove = new ItemStack(Abyssium2ModItems.GRAINETOURNESOL);
