...
public class CuisiniereMiseAJourDuTickProcedure {
	public static void execute(LevelAccessor world, double x, double y, double z) {
		world.getBlockTicks().scheduleTick(new BlockPos((int) x, (int) y, (int) z),
				world.getBlockState(new BlockPos((int) x, (int) y, (int) z)).getBlock(), 100);
		if (Abyssium2ModVariables.WorldVariables.get(world).energie_dispo >= 10) {
			if (new Object() {
				...
				}
				{
					...
					if (_ent != null) {
						final int _sltid = 16;
						final ItemStack _setstack = new ItemStack(Abyssium2ModItems.BEIGNETDECREVETTE);
						...
						}.getAmount(world, new BlockPos((int) x, (int) y, (int) z), 16) + 1));
						_ent.getCapability(CapabilityItemHandler.ITEM_HANDLER_CAPABILITY, null).ifPresent(capability -> {
							if (capability instanceof IItemHandlerModifiable) {
			...
			if (new Object() {
				...
				}
				{
					...
					if (_ent != null) {
						final int _sltid = 16;
						final ItemStack _setstack = new ItemStack(Abyssium2ModItems.ASSIETTEDHUITRES);
						_setstack.setCount((int) (new Object() {
							public int getAmount(LevelAccessor world, BlockPos pos, int sltid) {
								AtomicInteger _retval = new AtomicInteger(0);
								BlockEntity _ent = world.getBlockEntity(pos);
