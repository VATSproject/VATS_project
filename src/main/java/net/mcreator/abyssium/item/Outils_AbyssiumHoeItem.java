...
public class Outils_AbyssiumHoeItem extends HoeItem {
	public Outils_AbyssiumHoeItem() {
		super(new Tier() {
			public int getUses() {
				return 2380;
			}
		...
		}, 0, -3f, new Item.Properties().tab(Abyssium2ModTabs.TAB_ABYSIUM));
		setRegistryName("outils_abyssium_hoe");
	}
}
